...
export const ENEMY = {
  WRAITH_AGGRO_RADIUS: 300,
  WRAITH_VERTICAL_BAND: 130,
  WRAITH_PATROL_SPEED: 0.0016,
  WRAITH_PATROL_LERP: 0.04,
  WRAITH_CHASE_LERP: 0.07,
  WRAITH_LUNGE_LERP: 0.14,
  WRAITH_LUNGE_DURATION: 340,
  WRAITH_LUNGE_COOLDOWN: 1500,
  WRAITH_AGGRO_TIMEOUT: 1500,
